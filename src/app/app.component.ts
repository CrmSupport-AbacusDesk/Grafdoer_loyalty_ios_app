...
import { GiftDetailPage } from '../pages/gift-gallery/gift-detail/gift-detail';
import { ProductsPage } from '../pages/products/products';
import { VideoPage } from '../pages/video/video';
import { ProfilePage } from '../pages/profile/profile';
import { MyCamplaintsPage } from '../pages/plumber-camplaints/my-camplaints/my-camplaints';
  ...
  constructor( private network :Network,
    ...
    initializeApp(){
      this.platform.ready().then(() => {
        ...
        this.statusBar.backgroundColorByHexString('#374d78');
        // this.initPushNotification();
    ...
    onSetSalesUserSideBarPage() {
      ...
      registrationid(registrationId){
        ...
        console.log("line 889",registrationId);
        ...
        setTimeout(() =>{
          ...
          .subscribe((r)=>
          {
            console.log("success line no==>",registrationId);
            console.log("")
