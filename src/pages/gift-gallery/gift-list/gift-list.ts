...
export class GiftListPage {
  ...
  getGiftList(search)
  {
    ...
    this.dbService.onPostRequestDataFromApi({'filter' : this.filter,'karigar_id':this.dbService.userStorageData.id},'app_karigar/giftList', this.dbService.rootUrl).subscribe( r =>
      {
        console.log(r);
