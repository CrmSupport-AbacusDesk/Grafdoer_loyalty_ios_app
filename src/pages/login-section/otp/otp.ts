...
export class OtpPage {
    ...
    constructor(public navCtrl: NavController,
        ...
        onSubmitUserOtpHandler() {
            ...
            this.dbService.onPostRequestDataFromApi({'mobile_no': this.mobileNo ,'mode' :'App'},'auth/login', this.dbService.rootUrl).subscribe( (result) => {
                ...
                if (result['status'] == 'NOT FOUND') {
                    ...
                    if ( result['user'].status != 'Verified' ) {
                        ...
                        let contactModal = this.modalCtrl.create(AboutusModalPage,{country:this.country});
        ...
        onResendOtpHandler() {
            ...
            this.dbService.onPostRequestDataFromApi({ login_data: this.form },'app_karigar/karigarLoginOtp', this.dbService.rootUrl).subscribe((r) => {
