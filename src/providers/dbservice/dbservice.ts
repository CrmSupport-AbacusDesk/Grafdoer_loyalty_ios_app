...
export class DbserviceProvider {
      ...
      public rootUrl: string= 'https://apps.abacusdesk.com/grafdoer/dd_api/'
      // public rootUrl: string =  'http://phpstack-83335-1824785.cloudwaysapps.com/dd_api/'                
      public rootUrlSfa: string =  'https://apps.abacusdesk.com/grafdoer/crm/api/app/'                          
      
      public server_url: string = this.rootUrl + 'index.php/app/';                              
      public image_url: string= 'https://apps.abacusdesk.com/grafdoer/dd_api/app/Http/Controllers/Admin/Master/appOfflineUploads/categoryImage/'
      
      public upload_url: string = this.rootUrl;
      public upload_url1: string = 'https://apps.abacusdesk.com/grafdoer/crm/api/uploads/';                           
      public upload_url2: string = 'https://apps.abacusdesk.com/grafdoer/uploads/order-invoice/';                           
      public upload_url3: string = 'https://apps.abacusdesk.com/grafdoer/dd_api/app/uploads/';
      public video_url: string = 'https://apps.abacusdesk.com/grafdoer/dd_api/app/uploads/videos/';       
      public product_image_url: string = 'https://apps.abacusdesk.com/grafdoer/dd_api/app/Http/Controllers/Admin/Master/appOfflineUploads/productImage/';    
      public category_url: string = 'https://apps.abacusdesk.com/grafdoer/dd_api/app/Http/Controllers/Admin/Master/appOfflineUploads/imageCatalogue/';                   
